...
## Corpus Check
- 370 files · ~369,583 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6412 nodes · 8780 edges · 280 communities (196 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9aa5cf75`
...
## Communities (280 total, 69 thin omitted)
...
Cohesion: 0.15
Nodes (27): AstNode, ListType, collect_inline_text(), collect_plain_text(), convert_markdown(), converts_allowlisted_inline_html_and_drops_other_tags(), converts_core_gfm_to_editable_typst(), converts_nested_structure_and_line_markup() (+19 more)
...
Cohesion: 0.05
Nodes (31): package:crypto/crypto.dart, package:tylog/app_mobile.dart, package:tylog_core/models.dart, package:tylog/editor_autocomplete.dart, package:tylog/knowledge_screen.dart, package:tylog/widgets/note_picker_sheet.dart, hash, main (+23 more)
...
Cohesion: 0.05
Nodes (70): dart:async, dart:io, main, smokeValue, json, main, normalized, _normalizedMetadata (+62 more)
...
Cohesion: 0.04
Nodes (44): dart:ui, EditableText, EditableTextState, budget, countLine, fontSize, GraphLabelSpec, kGraphCountAlpha (+36 more)

### Community 51 - "preprocess"
Cohesion: 0.14
Nodes (23): Fn, asset_basename(), extract_highlights(), extract_math(), image_destination(), is_image_path(), is_relative_image(), parse_list() (+15 more)
...
Cohesion: 0.04
Nodes (47): dart:convert, HttpServer, archiveGets, bytes, close, config, etag, files (+39 more)
...
Cohesion: 0.05
Nodes (42): Directory, package:tylog/vault_lock.dart, package:tylog/vault_service.dart, IndexDonorStore, LocalVaultStorage, age, delete, _donorJson (+34 more)
...
Cohesion: 0.08
Nodes (22): app_mobile.dart, double?, main, iconForKind, kLightHint, kLightOnSurfaceVariant, kLightSurface, kMinTapTarget (+14 more)
...
Cohesion: 0.15
Nodes (20): raw_fence(), write_raw_block(), write_raw_inline(), parse_frontmatter(), sanitize_title(), typst_string(), typst_tuple(), yaml_scalar() (+12 more)
...
### Community 119 - "scanner_task_mutation_test.dart"
Cohesion: 0.20
...
### Community 125 - "flutter_typst_inspector.dart"
Cohesion: 0.22
...
### Community 130 - "Explicit Non-Goals (no WYSIWYG, collaboration, AI/RAG, plugins)"
Cohesion: 0.25
...
### Community 133 - "tylog_core/test/search_index_test.dart"
Cohesion: 0.25
...
Cohesion: 0.12
Nodes (8): P01 — production phone backup and inventory, P01a — Android recovery tool review, P02 — restore production vault and normal release, P05.2 result — numerical reference runner, P09b result — deterministic legacy manifest, P09c1 result — atomic imported-node materialization, P09c2a result — durable import-job initialization, P09c2b result — resumable batch runner
...
### Community 160 - "writer_compiles_test.dart"
Cohesion: 0.25
...
Cohesion: 0.09
Nodes (21): appVersion, package:flutter/foundation.dart, package:flutter/services.dart, package:tylog/controlled_editor.dart, package:tylog/task_scheduler.dart, PlatformException, random note with no, main (+13 more)
...
### Community 262 - "legacy_import_runner.dart"
Cohesion: 0.07
Nodes (27): _, @DriftDatabase, TyLogDatabase, LegacyImportManifest, _code, converter, database, LegacyImportRunner (+19 more)
...
## Knowledge Gaps
- **4374 isolated node(s):** `_GatedWebDavServer`, `timeout`, `deadline`, `calls`, `_files` (+4369 more)
...
- **Why does `String` connect `String` to `logseq_import.rs`, `Self`, `typst.rs`, `quicklook_ffi.rs`, `preprocess`, `src/vault_import.rs`, `tylog_import_core/src/lib.rs`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
