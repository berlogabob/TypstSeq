...
## Corpus Check
- 447 files · ~403,718 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7097 nodes · 9682 edges · 339 communities (221 shown, 103 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 90 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `242fdd69`
...
## Communities (339 total, 103 thin omitted)
...
### Community 79 - "legacy_import_runner.dart"
Cohesion: 0.08
...
### Community 119 - "agenda_filter_test.dart"
Cohesion: 0.50
...
### Community 144 - "benchmark_dart_retrieval.dart"
Cohesion: 0.10
...
### Community 158 - "articles_shelf_test.dart"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (72): dart:async, dart:io, main, smokeValue, json, main, normalized, _normalizedMetadata (+64 more)
...
Cohesion: 0.07
Nodes (27): package:crypto/crypto.dart, createDirectory, delete, exists, hash, isDirectory, list, modified (+19 more)
...
Cohesion: 0.04
Nodes (56): _, @DriftDatabase, dart:convert, FormatException, TyLogDatabase, package:archive/archive.dart, package:drift/drift.dart, package:drift/native.dart (+48 more)
...
### Community 291 - "State"
Cohesion: 0.14
Nodes (20): _NativeMagicHarness, _NativeMagicHarnessState, KnowledgeScreen, _KnowledgeScreenState, TriageMissingPagesScreen, _TriageMissingPagesScreenState, CalendarTab, _CalendarTabState (+12 more)
...
### Community 323 - "design_tokens_test.dart"
Cohesion: 0.40
...
## Knowledge Gaps
- **4889 isolated node(s):** `_GatedWebDavServer`, `timeout`, `deadline`, `calls`, `_files` (+4884 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 5346 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
...
- **What connects `_GatedWebDavServer`, `timeout`, `deadline` to the rest of the system?**
  _4889 weakly-connected nodes found - possible documentation gaps or missing edges._
