...
| P21 | Hybrid retrieval/cited navigation | P13,P19,P20 | RUNNING | SQLite-backed vector bridge now lands; query embedding, FTS fusion UI, cited navigation, and Dart/device gates remain |
