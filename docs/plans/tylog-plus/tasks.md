...
| P12f editor mode gate | Coordinator | IN PROGRESS | P12e | Long plain notes (>=200 blocks or >=32 KB, no protected/inline atoms) now use the stock TextField path; A24 typing capture still required before acceptance |
