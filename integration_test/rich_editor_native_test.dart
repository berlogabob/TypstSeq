...
MagicRequest _requestFor(MagicAction action) => switch (action) {
  ...
  MagicAction.strike => const MagicRequest(action: MagicAction.strike),
  MagicAction.underline => const MagicRequest(action: MagicAction.underline),
  MagicAction.mono => const MagicRequest(action: MagicAction.mono),
  MagicAction.highlight => const MagicRequest(action: MagicAction.highlight),
...
String _sourceMarker(MagicAction action) => switch (action) {
  ...
  MagicAction.strike => '#strike[',
  MagicAction.underline => '#underline[',
  MagicAction.mono => '`',
  MagicAction.highlight => '#highlight[',
