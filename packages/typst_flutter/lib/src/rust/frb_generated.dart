...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<MarkdownTypstResult> crateApiMarkdownImportConvertMarkdown({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_markdown_typst_result,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiMarkdownImportConvertMarkdownConstMeta,
        argValues: [markdown, title, baseUrl],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiMarkdownImportConvertMarkdownConstMeta =>
      const TaskConstMeta(
        debugName: "convert_markdown",
        argNames: ["markdown", "title", "baseUrl"],
      );
  ...
  MarkdownImportDiagnostic dco_decode_markdown_import_diagnostic(dynamic raw) {
    ...
    return MarkdownImportDiagnostic(
      code: dco_decode_String(arr[0]),
      message: dco_decode_String(arr[1]),
      line: dco_decode_opt_box_autoadd_usize(arr[2]),
    );
  }
  ...
  MarkdownTypstResult dco_decode_markdown_typst_result(dynamic raw) {
    ...
    return MarkdownTypstResult(
      typst: dco_decode_String(arr[0]),
      diagnostics: dco_decode_list_markdown_import_diagnostic(arr[1]),
    );
  }
  ...
  List<MarkdownImportDiagnostic> sse_decode_list_markdown_import_diagnostic(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MarkdownImportDiagnostic>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
  ...
  MarkdownImportDiagnostic sse_decode_markdown_import_diagnostic(
    ...
    var var_line = sse_decode_opt_box_autoadd_usize(deserializer);
    return MarkdownImportDiagnostic(
      code: var_code,
      message: var_message,
      line: var_line,
  ...
  MarkdownTypstResult sse_decode_markdown_typst_result(
    ...
    var var_diagnostics = sse_decode_list_markdown_import_diagnostic(
      deserializer,
    );
    return MarkdownTypstResult(typst: var_typst, diagnostics: var_diagnostics);
  }
  ...
  void sse_encode_markdown_import_diagnostic(
    ...
    sse_encode_opt_box_autoadd_usize(self.line, serializer);
  }
  ...
  void sse_encode_markdown_typst_result(
    ...
    sse_encode_list_markdown_import_diagnostic(self.diagnostics, serializer);
  }
