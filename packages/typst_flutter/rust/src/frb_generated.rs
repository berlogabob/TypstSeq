...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 618104202;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        12 => wire__crate__api__markdown_import__convert_markdown_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        13 => wire__crate__api__vault_import__convert_vault_note_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__typst__get_typst_version_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
